...
// @ts-ignore
import { EffectPass, KernelSize, FXAAEffect, Selection, SMAAEffect, SMAAPreset, BlendFunction, EdgeDetectionMode, PredicationMode, TextureEffect, GlitchEffect, ChromaticAberrationEffect } from "postprocessing";
//Custom PostProcessing
// @ts-ignore
import { SelectiveBloomEffect, NoiseEffect } from '../../../lib/local/customPostprocessing.js';
import { PostProcessingInstruction } from '../Types/PostProcessingInstruction.js';
export function ApplyBlooms(composer, scene, camera, instructions, currentLayer) {
...
export function ApplyNoise(composer, camera) {
...
export function ApplyFlicker(composer, camera) {
...
export function ApplyChromaticAbberation(composer, camera) {
...
//# sourceMappingURL=PostProcesses.js.map