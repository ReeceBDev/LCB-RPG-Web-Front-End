...
export class ColourPalette extends UserInterfaceScene {
    ...
    postprocessConfig = new Array } = {}) {
        ...
        let matrixGreenGeometries = new Array;
    ...
    NewMatrixGreenGeometries(scene) {
    ...
    NewConditionBlueGeometries(scene) {
        const objectList = new Array;
        //Geometries
        const solidBox = new THREE.BoxGeometry(1, 1, 1);
        const boxOutline = new THREE.EdgesGeometry(solidBox);
    ...
    NewAlertYellowGeometries(scene) {
        const objectList = new Array;
        //Geometries
        const solidBox = new THREE.BoxGeometry(1, 1, 1);
        const boxOutline = new THREE.EdgesGeometry(solidBox);
    ...
    NewEmergencyOrangeGeometries(scene) {
        const objectList = new Array;
        //Geometries
        const solidBox = new THREE.BoxGeometry(1, 1, 1);
        const boxOutline = new THREE.EdgesGeometry(solidBox);
